              ...
              >
                <div className="flex items-start justify-between">
                  <div className="space-y-2">
                    ...
                    <p className="text-sage-600">Party of {guest.party_size}</p>
                  ...
                  <Button className="bg-sage-700 hover:bg-sage-800 text-white font-medium px-4 py-2 rounded-md transition duration-300">
                    Select
                  </Button>
                </div>
              </div>
          ...
          <div className="text-center">
            ...
            <div className="text-left max-w-md mx-auto">
              ...
              <p className="text-sage-700 text-center">
                ...
                <a
                  href="/contact"
                  className="text-sage-800 hover:text-sage-900 underline font-medium"
                >
                  contact us
                </a>{" "}
                for assistance.
